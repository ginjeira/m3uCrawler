...
- **Cobertura de testes**: 1066 testes unitários (44 novos para o catálogo persistente + ownership filter + SPORT TV NBA autónomo), 0 warnings em `dotnet build m3uCrawler.sln --configuration Release` (snapshot em 2026-09-04; warning CS8629 em `ChannelMatcher.cs:267` é pré-existente do iter anterior e está fora do escopo desta iteração).
